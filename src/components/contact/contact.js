  ...
  return(
    <div id='footer' className='contactContainer'>
      <div className='contactImageContainer'>
        ...
        <a href="https://dev.to/neosunderground"><div className='br4 shadow-2 pa2 ma1 grow bounce-6 badge1'><img src="https://d2fltix0v2e0sb.cloudfront.net/dev-badge.svg" style={{width:"40px", height:"40px"}} alt="NeosUnderground's DEV Profile"/></div></a>
      </div>
